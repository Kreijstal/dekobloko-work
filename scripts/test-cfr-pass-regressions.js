...
const scenarios = [
  ...
  },
  {
    ...
    expectedBaseline: { markers: 1, bad: false },
    expectedCandidate: { markers: 0, bad: false },
    expectChanged: true,
  },
  {
    name: 'steelsentinels/ji byte wrap scan tail clone removes scan gotos',
    classFile: '.work/games/steelsentinels/deob-safe/out/ji.class',
    pass: 'structured-ji-byte-wrap-scan-tails',
    expectedBaseline: { markers: 11, bad: true },
    expectedCandidate: { markers: 0, bad: true },
    expectChanged: true,
  },
  {
    ...
    expectedBaseline: { markers: 2, bad: true },
    expectedCandidate: { markers: 0, bad: true },
    expectChanged: true,
  },
  {
    ...
    expectedBaseline: { markers: 5, bad: true },
    expectedCandidate: { markers: 0, bad: true },
    expectChanged: true,
  },
  {
