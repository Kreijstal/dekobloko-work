        ...
        try {
...

            {
                ...
                synchronized (var3_6) {
                    if (~this.f == ~this.q) {
                        if (this.g) {
                            // MONITOREXIT @DISABLED, blocks:[0, 16, 6, 12, 15] lbl8 : MonitorExitStatement: MONITOREXIT : var3_6
                            try {
                                if (null != this.o) {
                                    this.o.close();
                                }
                ...
                try {
                    this.b.write(this.h, var2_5, var1_2);
                }
...
lbl42:
            ...
            throw dh.a((Throwable)var1_4, (String)"qk.run()");
        }
    }
